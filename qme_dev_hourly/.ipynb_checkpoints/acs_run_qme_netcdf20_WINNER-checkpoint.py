...
# outdir = "/g/data/xv83/users/at2708/bias_adjustment_acs_qme/qme_dev_copy_hourly/outputs_netcdf2netcdf/"
outdir = "/g/data/xv83/users/at2708/bias_adjustment_acs_qme/qme_dev_copy_hourly/outputs_netcdf2netcdf2/"
...
if __name__ == "__main__":
    ...
    if var in ("tasmax", "tasmin", "tas"):
        ...
        mdl_raw_means = xr.open_mfdataset(fut_file_list, preprocess=preproc_find_mean, parallel = True, engine='h5netcdf',chunks={"time": chunk_time, "lat": chunk_lat, "lon": chunk_lon}).persist() #Alicia , engine='h5netcdf',chunks={"time": chunk_time, "lat": chunk_lat, "lon": chunk_lon}
...
# ####### end Alicia
    ...
    ref_data_full = xr.open_mfdataset(ref_file_list, preprocess = preprocess_ds, parallel = True, engine='h5netcdf',chunks={"time": chunk_time, "lat": chunk_lat, "lon": chunk_lon}) #Alicia
    hist_data_full = xr.open_mfdataset(hist_file_list, parallel = True, engine='h5netcdf',chunks={"time": chunk_time, "lat": chunk_lat, "lon": chunk_lon}) #Alicia
