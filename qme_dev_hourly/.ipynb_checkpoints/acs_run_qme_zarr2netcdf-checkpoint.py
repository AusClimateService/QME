...
sys.path.append('/g/data/xv83/users/at2708/bias_adjustment_acs_qme/qme_dev_hourly')
...
outdir = "/g/data/xv83/users/at2708/bias_adjustment_acs_qme/qme_dev_hourly/outputs_zarr2netcdf/"
...
def adjust_attrs(ds, var):
    ...
    # general attributes
    fconfig = f'/g/data/xv83/users/at2708/bias_adjustment_acs_qme/qme_dev_hourly/acs_attrs_{ref}_{empat}.yml'
...
if __name__ == "__main__":
    ...
    ref_data_full=preprocess_ds(ref_data_full) #Zarr
    ...
    for file in fut_file_list_netcdf:
        ...
        fut_data_bc = adjust_attrs(fut_data_bc, var).chunk({'time': chunk_time, 'lat': chunk_lat, 'lon': chunk_lon}) #Alicia
